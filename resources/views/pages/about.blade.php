...
{{-- 
<h1>{{$title}}</h1>
<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusamus, laborum sed at, pariatur assumenda voluptas aliquam, non est earum quidem libero. Perferendis quaerat animi deserunt ratione tenetur magni eaque nemo?</p> --}}
{{-- bootstrap --}}
    ...
    <div class="container py-5">
      <div class="row h-100 align-items-center py-5">
        <div class="col-lg-6">
          ...
          <p class="lead text-muted mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod </p>
